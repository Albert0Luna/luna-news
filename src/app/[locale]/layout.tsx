...
export function metadata () {
  ...
  const dynamicMetadata: Metadata =  {
    ...
    keywords: `${lang === 'es' 
      ...
      : 'Sections, Luna News, Luna, News, Technology, Smarthphones, Gadgets, AI, Tutorial, Programming, Gaming, Reviews, Analysis, PCs & Laptops, Mobile, Tablets, Wearables, VR, AR, IoT, Apps, Software, Hardware, Opinion, Analysis, Editorial, Interview, Report, Review, Tutorial, Guide, Tips, Tricks, How to, Best, Top, Popular, Trending, Latest, Breaking, Exclusive, Special, Comparison, Versus, Versus'}`,
    ...
    alternates: {
      canonical: `https://lunanews.tech/${lang ?? 'en'}`,
      languages: {
